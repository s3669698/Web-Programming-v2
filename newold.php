...
<body>
    ...
    <main>
        ...
        <div class="row">
            ...
            <div class="column">
                <a href="product.php"><img src="media/shoes3.jpg" alt="Details"></a>
                <a href="product.php"><h2>Shirt</h2></a>
                <p> High Tech </p>
                <p> Release Date: 12/12/2012</p>
                <p class="price">$1.56</p>
            </div> 
            <div class="column">
                <a href="products1.php"><img src="media/tshirt.jpg" alt="Details"></a>
            ...
            <div class="column">
                <a href="product.php"><img src="media/shoes1.jpg" alt="Details"></a>
                <a href="product.php"><h2>Shoes</h2></a>
                <p> Running </p>
                <p> Release Date: 12/12/2012</p>
        ...
        <div class="row">  
            <div class="column">
                <a href="products1.php"><img src="media/shoes2.jpg" alt="Details" sizes="width:30%" ></a>
            ...
            <div class="column">
                <a href="product.php"><img src="media/shirt.jpg" alt="Details" sizes="width:30%" ></a>
                <a href="product.php"><h2>T-Shirt</h2></a>
                <p> High Quality </p>
                <p> Release Date: 12/12/2012</p>
                <p class="price">$1.23</p>
            </div>
            ...
            <div class="column">
                <a href="product.php"><img src="media/shoes.jpg" alt="Details" sizes="width:30%" ></a>
                <a href="product.php"><h2>Shoes</h2></a>
                <p> Best seller </p>
                <p> Release Date: 12/12/2012</p>
                <p class="price">$1.45</p>
